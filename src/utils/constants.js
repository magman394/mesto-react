...
export const showDelPopup = '#popupDelCard';
export const DelSubmit = '.popup__close_cards';
export const DelCard = '#cardElement';
...
export const boxCards = '#boxCards';
export const firstNameContainer = '.profile__name';

    ...
    return (
        <main class="content">
          <section class="profile">
            <botton class="profile__botton" type="button" onClick={this.handleEditAvatarClick}><img class="profile__avatar opacity-link opacity-link_avatar" src={Avatar} alt="аватарка"/></botton>
              <div class="profile__profile-info">
                <div class="profile__edit-name">
                  <h1 class="profile__name"></h1>
                  <button type="button" class="profile__edit-botton opacity-link" onClick={this.handleEditProfileClick}><img src={ProfileEditBotton} alt="кнопка редактирования"/></button>
                </div>
                <h2 class="profile__profession"></h2>
              </div>
            <button type="button" class="profile__add-botton opacity-link" onClick={this.handleAddPlaceClick}><img src={ProfileAddBotton} alt="кнопка добавления"/></button>
          </section>
